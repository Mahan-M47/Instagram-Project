...
public class SearchPageController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources)
    {
        ...
        if (searchResults.size() > 0) { link1.setText( searchResults.get(0) ); }
        if (searchResults.size() > 1) { link1.setText( searchResults.get(1) ); }
        if (searchResults.size() > 2) { link1.setText( searchResults.get(2) ); }
        if (searchResults.size() > 3) { link1.setText( searchResults.get(3) ); }
        if (searchResults.size() > 4) { link1.setText( searchResults.get(4) ); }
        if (searchResults.size() > 5) { link1.setText( searchResults.get(5) ); }
        if (searchResults.size() > 6) { link1.setText( searchResults.get(6) ); }
        if (searchResults.size() > 7) { link1.setText( searchResults.get(7) ); }
